  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <h1 className="mt-6 text-white text-5xl font-bold leading-tight">
        ...
        <div className="mt-3 pt-3 border-t border-gray-600 flex items-center justify-between text-gray-100">
